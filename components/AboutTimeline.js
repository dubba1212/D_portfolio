      ...
      <div className="space-y-16">
        {experiences.map((exp, index) => (
          ...
          >
            ...
            <div className={`w-full md:w-[45%] bg-white/5 backdrop-blur-lg border border-white/10 p-6 rounded-2xl shadow-xl hover:shadow-accent/40 transition-all duration-500 group relative overflow-hidden`}>
              {/* Active Glow Ring */}
